...
class BlueRatioCirculator(Node):
    ...
    def __init__(self):
        ...
        self.image_timer = self.create_timer(1/24, self.image_capture)
        self.pub_timer = self.create_timer(1/24, self.publish_timer)
    ...
    def image_capture(self):
        ...
        if not ret :
            ...
            self.resized = cv2.resize(img, (320,180),interpolation=cv2.INTER_AREA)
    ...
    def publish_timer(self) :
        ...
        self.img_publisher.publish(self.cvbrid.cv2_to_imgmsg(self.resized))
