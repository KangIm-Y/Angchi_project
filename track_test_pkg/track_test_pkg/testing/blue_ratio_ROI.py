...
class BlueRatioCirculator(Node):
    ...
    def image_capture(self):
        ...
        if not ret :
            ...
            mission_ROI = img[int(self.img_size_y * (1-(self.ROI_ratio + self.mission_ROI_ratio))):int(self.img_size_y * (1-self.ROI_ratio)),:].copy()
            
            cv2.rectangle(img,(0,int(self.img_size_y * (1-self.ROI_ratio))),(self.img_size_x, self.img_size_y),(255,0,0),2)
            cv2.rectangle(img,(0,int(self.img_size_y * (1-self.ROI_ratio- self.mission_ROI_ratio))),(self.img_size_x, int(self.img_size_y* (1-self.ROI_ratio))),(0,255,0),2)
