...
class TripSub(Node):
    ...
    def callback(self, msg):
        ...
        if dxl_comm_result != COMM_SUCCESS:
            ...
            goal_position1 = round(goal_position1*0.088)
        ...
        if dxl2_comm_result != COMM_SUCCESS:
            ...
            goal_position2 = round(goal_position2*0.088)
        ...
        if dxl3_comm_result != COMM_SUCCESS:
            ...
            goal_position3 = round(goal_position3*0.088)
        ...
        if dxl_comm_result == COMM_SUCCESS:
            dxl1_present_position = -dxl1_present_position/4.096
            self.get_logger().info(f'ID1 ENCODER: {dxl1_present_position}')
        ...
        if dxl2_comm_result == COMM_SUCCESS:
            ...
            dxl2_present_position = -dxl2_present_position/4.096
            self.get_logger().info(f'ID2 ENCODER: {dxl2_present_position}')
        ...
        if dxl3_comm_result == COMM_SUCCESS:
            dxl3_present_position = -dxl3_present_position/4.096
            self.get_logger().info(f'ID3 ENCODER: {dxl3_present_position}')
